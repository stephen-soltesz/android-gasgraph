...
public class CustomGallery extends CustomAbsSpinner implements GestureDetector.OnGestureListener {
        ...
        public CustomGallery(Context context, AttributeSet attrs) {
            this(context, attrs, R.attr.customGalleryStyle);
        }
        ...
        public CustomGallery(Context context, AttributeSet attrs, int defStyle) {
            ...
            TypedArray a = context.obtainStyledAttributes(
                    attrs, R.styleable.CustomGallery, defStyle, 0);
    
            int index = a.getInt(R.styleable.CustomGallery_gravity, -1);
            if (index >= 0) {
                setGravity(index);
            }
    
            int animationDuration =
                    a.getInt(R.styleable.CustomGallery_animationDuration, -1);
            if (animationDuration > 0) {
                setAnimationDuration(animationDuration);
            }
    
            int spacing =
                    a.getDimensionPixelOffset(R.styleable.CustomGallery_spacing, 0);
            setSpacing(spacing);
    
            float unselectedAlpha = a.getFloat(
                    R.styleable.CustomGallery_unselectedAlpha, 0.5f);
        ...
        protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
            /*
             * Gallery expects CustomGallery.LayoutParams.
             */
